...
export const APP_NAME = 'FunckleTest'
export const SERVER_URL = 'https://speckle.xyz'
export const TOKEN = `${APP_NAME}.AuthToken`
export const REFRESH_TOKEN = `${APP_NAME}.RefreshToken`
export const CHALLENGE = `${APP_NAME}.Challenge`
const SPECKLE_APP_ID = process.env.NODE_ENV === 'production' ? '6d4602fb2f' : '9397f1dfb2'
const SPECKLE_APP_SECRET = process.env.NODE_ENV === 'production' ? '75c30891e7' : '94217b3eee'
